# -*- coding: utf-8 -*-
"""Safa Habibi-24849460-DL Project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Mbyf0YsnLXMrl9zYX3ADQe6td2M-dlSw

#**Downloading Selected Classes from Quick, Draw! Dataset**
This part creates a folder and downloads 5 classes (apple, car, cat, dog, flower) from the Quick, Draw! dataset. Each class is saved as a .npy file. We will use these files to train our models.
"""
...
# 
# # categories=(
# #     "airplane" "apple" "bicycle" "bus" "car" "cat" "clock" "cloud"
# #     "dog" "fish" "flower" "house" "laptop" "pizza" "star" "sun" "tree" "umbrella"
# # )
# 
# categories=("apple" "car" "cat" "dog" "flower" )
# 
# for category in "${categories[@]}"
# do
#     echo "Downloading $category..."
#     gsutil cp "gs://quickdraw_dataset/full/numpy_bitmap/${category}.npy" quickdraw_dataset/
# done
#

"""#**Data Preparation and Training Tools**
This section prepares the Quick, Draw! dataset, sets up data loaders, defines transformations, and provides helper functions for training, evaluating, and plotting results. It also includes metric tracking (accuracy, precision, recall, F1) and ROC curve generation.
